...
public class TestPowerRating {
	...
	public void testCompareTo() {
		...
		Card[] testArr = {new Card(10, Suit.CLUBS), new Card(11, Suit.CLUBS), 
				new Card(6, Suit.DIAMONDS), new Card(13, Suit.CLUBS), new Card(8, Suit.HEARTS)};
		PokerHand h1 = new PokerHand(new Card(2, Suit.SPADES), new Card(11, Suit.HEARTS));

		PowerRating ph1 = new PowerRating(h1, testArr);
		...
		d.remove(h1.getC1());
		d.remove(h1.getC2());
		for(PokerHand ph : CardUtils.permuteDeck(d)){
			try{
				assertNotNull(ph1.compareTo(new PowerRating(ph, testArr)));
